...
class User extends Authenticatable implements MustVerifyEmail {
    ...
    public function department() {
        return $this->belongsTo('App\Models\Department', 'department')->withDefault(['name' => _lang('Default')]);
    }

    public function product() {
        return $this->belongsTo('App\Models\Product', 'product_id')->withDefault(['name' => _lang('Default')]);
    }
