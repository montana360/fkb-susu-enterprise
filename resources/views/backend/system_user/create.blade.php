                ...
                <form method="post" class="validate" autocomplete="off" action="{{ route('system_users.store') }}"
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-form-label">{{ _lang('Department') }}</label>
                                <div class="col-xl-9">
                                    <select class="form-control select2-ajax" data-href="{{ route('departments.create') }}" data-title="{{ _lang('Department') }}" data-value="id" data-display="name"
                                        data-table="departments" id="department" name="department" disabled>
                                    </select>
                                </div>
                            </div>
