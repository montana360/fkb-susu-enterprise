                ...
                <form method="post" class="validate" autocomplete="off"
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-form-label">{{ _lang('User Department') }}</label>
                                <div class="col-xl-9">
                                    <select class="form-control select2-ajax" data-href="{{ route('departments.create') }}" data-title="{{ _lang('Add Department') }}" data-value="id" data-display="name"
                                        data-table="departments" id="department" name="department">
                                        {{ create_option("departments","id","name", $user->department) }}
                                    </select>
                                </div>
                            </div>
