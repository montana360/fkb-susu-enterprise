	...
	<div class="row p-2">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<select class="form-control select2-ajax" data-href="{{ route('departments.create') }}" data-title="{{ _lang('department') }}" data-value="id" data-display="name" data-table="departments" id="department" name="department">
				</select>
			</div>
		</div>
