                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <input type="text" class="form-control" name="nok" value="{{ $user->nok }}"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <input type="text" class="form-control" name="sof" value="{{ $user->sof }}"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <select class="form-control auto-select" data-selected="{{ $user->gender }}"
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-form-label">{{ _lang('Product') }}</label>
                                <div class="col-xl-9">
                                    <select class="form-control auto-select" data-selected="{{ $user->product_id }}"
                                        name="product_id">
                                        <option value="">{{ _lang('Select One') }}</option>
