...
<div class="row">
    <div class="col-md-4 col-lg-3">
		<ul class="nav flex-column nav-tabs settings-tab" role="tablist">
			 ...
			 <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#add_money"><i class="icofont-plus-circle"></i> {{ _lang('Credit Account') }}</a></li>
			 <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#deduct_money"><i class="icofont-minus-circle"></i> {{ _lang('Debit Account') }}</a></li>
    ...
    <div class="col-md-8 col-lg-9">
        <div class="tab-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>{{ _lang('Next of Kin') }}</td>
                                <td>{{ $user->nok }}</td>
                            </tr>
                            <tr>
                                <td>{{ _lang('Source of Financing') }}</td>
                                <td>{{ $user->sof }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>{{ _lang('Account Openned By') }}</td>
                                <td>{{ $user->created_by->name }}</td>
                            </tr>
                           
                            <tr>
                                 <td>{{ _lang("Approved Status") }}</td>
                                 <td>
                                        @if($user->approved_status == 0)
                                        {!! xss_clean(show_status(_lang('Pending'), 'warning')) !!}
                                        @elseif($user->approved_status == 1)
                                        {!! xss_clean(show_status(_lang('Approved'), 'success')) !!}
                                        @elseif($user->approved_status == 2)
                                        {!! xss_clean(show_status(_lang('Rejected'), 'danger')) !!}
                                        @endif

                                        @if($user->approved_status == 0)
                                        <!-- life is simple -->
                                        <a class="btn btn-outline-primary btn-sm" href="{{ action('UserController@approve', $user['id']) }}"><i class="icofont-check-circled"></i> {{ _lang("Click to Approve") }}</a>
                                        <a class="btn btn-outline-danger btn-sm float-right" href="{{ action('UserController@reject', $user['id']) }}"><i class="icofont-close-line-circled"></i> {{ _lang("Click to Reject") }}</a>
                                        @endif
                                    </td>
                            </tr>
            ...
            <div id="deduct_money" class="tab-pane">
                <div class="card">
                    <div class="card-header">
                        <span class="header-title">{{ _lang('Debit Account') }}</span>
                    </div>
